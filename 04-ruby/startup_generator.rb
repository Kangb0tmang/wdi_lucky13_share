...
solution = this_array.sample
audience = that_array.sample

# Different ways of outputting it
idea = "#{solution} for #{audience}"
idea = "#{this_array.sample} for #{that_array.sample}"
puts "#{this_array.sample} for #{that_array.sample}"
puts(idea)

# binding.pry #like the debugger
